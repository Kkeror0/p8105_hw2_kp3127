...
Merge the two files. Before we merge, we need to check for completeness and correctness across datasets.
...
For example, ZIP codes `r paste(head(zip_missing, 3), collapse = ", ")` are in the geographic reference file but not in Zillow’s rental index.  
